...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    //primary colors
    primary1: darkMode ? '#017BFF' : '#017BFF',
    primary2: darkMode ? '#3680E7' : '#017BFF',
    ...
    placeholderColor: darkMode ? '#969696' : '#cccccc'
  }
}
